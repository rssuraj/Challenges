...
public class MinSwaps {
	...
	public static void main(String[] args) {
		int[] arr1 = {4, 3, 1, 2};
		System.out.println("Swaps for array " + getString(arr1) + " are " + minimumSwaps(arr1));
		
		int[] arr2 = {2, 3, 4, 1, 5};
		System.out.println("Swaps for array " + getString(arr2) + " are " + minimumSwaps(arr2));
		
		int[] arr3 = {1, 3, 5, 2, 4, 6, 7};
		System.out.println("Swaps for array " + getString(arr3) + " are " + minimumSwaps(arr3));
	}
